...
zorlukSec();
List<int> mayinlar = mayinlariYerlestir(seviye, sinir, mayinsayisi);
...
void zorlukSec()
{
    int zorluk = 0;
    Console.Clear();
    MesajYaz("\tKolay Seviye İçin 1 e Basınız.", ConsoleColor.Green);
    MesajYaz("\tNormal Seviye İçin 2 e Basınız.", ConsoleColor.Blue);
    MesajYaz("\tZor Seviye İçin 3 e Basınız.", ConsoleColor.Red);
    MesajYaz("\tYukarıdan Bir Zorluk Seçiniz", ConsoleColor.Black);
    zorluk = Convert.ToInt32(Console.ReadLine());
