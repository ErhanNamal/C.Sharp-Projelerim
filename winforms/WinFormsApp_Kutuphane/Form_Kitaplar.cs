...
namespace WinFormsApp_Kutuphane
{
    public partial class Form_Kitaplar : Form
    {
        ...
        private void Form_Kitaplar_Load(object sender, EventArgs e)
        {
            ...
            Column_kAd.DataPropertyName = "baslik";
            Column_kYazar.DataPropertyName = "yazar";
            Column_kSayfa.DataPropertyName = "sayfa";
            Column_yayinYili.DataPropertyName = "yayinYili";

            Column_kTur.DataPropertyName = "tur";
            Column_kTur.DataSource = Enum.GetValues<Kitap.Kitaptur>();
        }
    }
}
